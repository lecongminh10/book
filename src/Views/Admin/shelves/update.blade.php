                ...
                <div class="card-body">
                    ...
                    <form action="" method="POST" id="shelf-form">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="name" name="name" value="{{ $shelf['name'] ?? '' }}" required maxlength="100">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="location_note" name="location_note" rows="2">{{ $shelf['location_note'] ?? '' }}</textarea>
                        </div>
                        <div class="row mb-3">
                            <div class="col-auto">
                                <label for="shelf-cols" class="form-label mb-0">Số box mỗi hàng:</label>
                                <input type="number" id="shelf-cols" name="shelf-cols" class="form-control" value="{{ $cols ?? 5 }}" min="1" max="20" style="width:80px;display:inline-block;">
                            </div>
                            <div class="col-auto">
                                <label for="shelf-rows" class="form-label mb-0">Số hàng:</label>
                                <input type="number" id="shelf-rows" name="shelf-rows" class="form-control" value="{{ $rows ?? 2 }}" min="1" max="20" style="width:80px;display:inline-block;">
                            </div>
                        </div>
                        <hr>
                        <h5>Vị trí sách trong kệ</h5>
                        @if(isset($errors['positions']))
                            <div class="text-danger mb-2">{{ $errors['positions'] }}</div>
                        @endif
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let oldPositions = @json($positions ?? []);
